...
Nous avons jugé bon de créer un module \textit{Utils} dans lequel se trouvent un certain nombre de classes utilitaires. Celles-ci s'occupent du stockage des clés, de petits traitements effectués sur les tableaux d'octets, etc., ce qui permet d'éviter la duplication de code et de simplifier le traitement des données. 
