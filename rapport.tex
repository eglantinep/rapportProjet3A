...
\begin{figure}[!ht]
    \centering
			\includegraphics[scale=0.5]{img/TokenizerDiagramm.png}
...
\begin{figure}[!ht]
    \centering
			\includegraphics[scale=0.5]{img/DetokenizerDiagramm.png}
...
\begin{figure}[!ht]
    \centering
			\includegraphics[scale=0.5]{img/TokenServiceProvider.png}
...
\begin{figure}[!ht]
    \centering
			\includegraphics[scale=0.5]{img/TokenRequester.png}
