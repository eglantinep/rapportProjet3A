...
Deux Data Elements sont utilisés pour founir des informations sur le Token Assurance Level et les méthodes d'ID \& V utilisées. Ce sont les champs : 
\begin{itemize}
	\item Token Assurance Level
	\item Token Assurance Data\\
\end{itemize}

Le Token Service Provider \textbf{DOIT} mettre en place les interfaces nécessaire pour founir ces deux Data Elements.
